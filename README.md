...
- `latexindent` será el único formatter permitido y es obligatorio. Se utiliza un git hook para asegurarnos que todos los archivos .tex estén formateados correctamente y es importante que todos los contribuidores lo implementen. Más info en [hook/README.md](hook/README.md)
